...
@Component({
  selector: 'app-conductivimetre-form',
  templateUrl: './conductivimetre-form.component.html',
  styleUrls: ['./conductivimetre-form.component.css']
})
export class ConductivimetreFormComponent implements OnInit {
  ...
  OnSubmit() {
    ...
    if (this.userService.Method == "Post") {
      ...
      this.equipementservice.formEquipement.value.libelle = "Conductivimetre"
      console.log(this.equipementservice.formEquipement)
      this.equipementservice.PostConductivimetre().subscribe(res => {
      ...
      this.equipementservice.PuttConductivimetre().subscribe(res => {
        if (res as Equipement) {
          this.bsModalRef.hide();
          this.equipementservice.GetListEquipementByFiliale(this.equipementservice.formEquipement.value.fkFiliale).subscribe(res => {
            this.equipementservice.listequipement = (res as Equipement[])
