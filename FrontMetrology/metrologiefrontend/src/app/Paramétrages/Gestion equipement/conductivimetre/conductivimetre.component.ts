...
@Component({
  selector: 'app-conductivimetre',
  templateUrl: './conductivimetre.component.html',
  styleUrls: ['./conductivimetre.component.css']
})
export class ConductivimetreComponent implements OnInit {
  ...
  OnSubmit(){
    ...
    this.equipementservice.formEquipement.value.libelle = "Conductivimètre"
