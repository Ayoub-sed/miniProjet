...
@Component({
  selector: 'app-capteur-de-pression-form',
  templateUrl: './capteur-de-pression-form.component.html',
  styleUrls: ['./capteur-de-pression-form.component.css']
})
export class CapteurDePressionFormComponent implements OnInit {
...
console.log("salemou ")
  ...
  OnSubmit() {
    if (this.userService.Method == "Post") {
      ...
      this.equipementservice.formEquipement.value.libelle = "CapteurDePression"
      console.log('helooooooooooooo',this.equipementservice.formEquipement)
      this.equipementservice.PostCapteurDePression().subscribe(res => {
