...
@Component({
  selector: 'app-debimetre-volumetrique-form',
  templateUrl: './debimetre-volumetrique-form.component.html',
  styleUrls: ['./debimetre-volumetrique-form.component.css']
})
export class DebimetreVolumetriqueFormComponent implements OnInit {
  ...
  OnSubmit() {
    ...
    if (this.userService.Method == "Post") {
      ...
      this.equipementservice.formEquipement.value.libelle = "DebimetreVolumetrique"
      console.log(this.equipementservice.formEquipement)
      this.equipementservice.PostDebimetreVolumetrique().subscribe(res => {
      ...
      this.equipementservice.PuttDebimetreVolumetrique().subscribe(res => {
        if (res as Equipement) {
          this.bsModalRef.hide();
