...
@Component({
  selector: 'app-thermometre-form',
  templateUrl: './thermometre-form.component.html',
  styleUrls: ['./thermometre-form.component.css']
})
export class ThermometreFormComponent implements OnInit {
  ...
  OnSubmit() {
    ...
    if (this.userService.Method == "Post") {
      ...
      this.equipementservice.formEquipement.value.libelle = "Thermometre"
      console.log('body request',this.equipementservice.formEquipement)
      ...
      this.equipementservice.PuttThermometre().subscribe(res => {
        if (res as Equipement) {
          this.bsModalRef.hide();
