...
@Component({
  selector: 'app-manometre-de-pression',
  templateUrl: './manometre-de-pression.component.html',
  styleUrls: ['./manometre-de-pression.component.css']
})
export class ManometreDePressionComponent implements OnInit {
  ...
  OnSubmit() {
    ...
    if (this.userService.Method == "Post") {
      ...
      this.equipementservice.formEquipement.value.libelle = "ManometreDePression"
      console.log(this.equipementservice.formEquipement)
      this.equipementservice.PostManometreDePression().subscribe(res => {
      ...
      this.equipementservice.PuttManometreDePression().subscribe(res => {
        if (res as Equipement) {
          this.bsModalRef.hide();
