...
@Component({
  selector: 'app-chambre-froide',
  templateUrl: './chambre-froide.component.html',
  styleUrls: ['./chambre-froide.component.css']
})
export class ChambreFroideComponent implements OnInit {
  ...
  OnSubmit() {
    ...
    if (this.userService.Method == "Post") {
      ...
      this.equipementservice.formEquipement.value.libelle = "ChambreFroide"
      console.log(this.equipementservice.formEquipement)
      this.equipementservice.PostChambreFroide().subscribe(res => {
      ...
      this.equipementservice.PuttChambreFroide().subscribe(res => {
        if (res as Equipement) {
          this.bsModalRef.hide();
          this.equipementservice.GetListEquipementByFiliale(this.equipementservice.formEquipement.value.fkFiliale).subscribe(res => {
            this.equipementservice.listequipement = (res as Equipement[])
