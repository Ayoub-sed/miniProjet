...
var FormattedTimePipe = /** @class */ (function (_super) {
    __extends(FormattedTimePipe, _super);
    function FormattedTimePipe(intlService, _ref, formatService) {
        return _super.call(this, intlService, _ref, formatService) || this;
    }
    FormattedTimePipe.prototype.isValidQuery = function (query) {
        return query && (query instanceof Date || isFinite(query));
    };
    FormattedTimePipe.prototype.updateValue = function (query, options) {
