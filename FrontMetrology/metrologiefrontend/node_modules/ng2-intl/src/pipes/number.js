...
var FormattedNumberPipe = /** @class */ (function (_super) {
    __extends(FormattedNumberPipe, _super);
    function FormattedNumberPipe(intlService, _ref, formatService) {
        return _super.call(this, intlService, _ref, formatService) || this;
    }
    FormattedNumberPipe.prototype.isValidQuery = function (query) {
        return query && ((typeof query === 'string' && query.length > 0) || isFinite(query));
    };
    FormattedNumberPipe.prototype.updateValue = function (query, options) {
