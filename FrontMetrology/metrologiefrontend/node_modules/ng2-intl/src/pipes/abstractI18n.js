var AbstractI18nPipe = /** @class */ (function () {
    function AbstractI18nPipe(intlService, _ref, formatService) {
     ...
     */
    AbstractI18nPipe.prototype.equals = function (o1, o2) {
        if (o1 === o2)
            return true;
        if (o1 === null || o2 === null)
            return false;
    ...
    AbstractI18nPipe.prototype.transform = function (query) {
        var _this = this;
        var args = [];
     ...
     * @private
     */
    AbstractI18nPipe.prototype._dispose = function () {
        if (typeof this.onLangChange !== 'undefined') {
            this.onLangChange.unsubscribe();
            this.onLangChange = undefined;
        }
    };
    AbstractI18nPipe.prototype.ngOnDestroy = function () {
        this._dispose();
    };
    return AbstractI18nPipe;
}());
export { AbstractI18nPipe };
